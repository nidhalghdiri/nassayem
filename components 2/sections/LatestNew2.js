...
export default function LatestNew2() {
	return (
		<>
						...
						<div className="box col-lg-4 col-md-6">
							<Link href="/blog-detail" className="flat-blog-item hover-img">
								...
								<div className="content-box">
									...
									<h6 className="title">Building gains into housing stocks and how to trade the sector
									</h6>
									<p className="description">The average contract interest rate for 30-year fixed-rate
						...
						<div className="box col-lg-4 col-md-6">
							<Link href="/blog-detail" className="flat-blog-item hover-img">
								...
								<div className="content-box">
									...
									<h6 className="title">92% of millennial homebuyers say inflation has impacted their
										plans</h6>
									<p className="description">Mortgage applications to purchase a home, however, dropped 4%
										last week compared...</p>
								</div>
							</Link>
						</div>
						<div className="box col-lg-4 col-md-6">
							<Link href="/blog-detail" className="flat-blog-item hover-img">
								...
								<div className="content-box">
									...
									<p className="description">New listings were down 20% year over year in March, according
										to Realtor.com, and total inventory...</p>
								</div>
							</Link>
						</div>
					</div>
