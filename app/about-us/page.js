            ...
            <div className="container">
              <div className="row">
                <div className="col-md-5">
                  <h3>
                    Welcome To <br /> Nassayem Salalah
                  </h3>
                </div>
                <div className="col-md-7 hover-btn-view">
                  <p className="body-2 text-variant-1">
                    ...
                    based in Salalah, Dhofar, Oman. We specialize in providing
                    exceptional short-term and long-term rental services,
                    offering a wide range of properties across key locations
                    such as Ouked, Wadi, Moutaza, Hay Tijari, and Sadaa. With a
                    customer-first approach, we ensure seamless hospitality
                    experiences, supported by comprehensive property management
                    solutions and 24/7 customer service.{" "}
                  </p>
                ...
                <div className="col-lg-6">
                  <div className="box-left">
                    <div className="box-title">
                      ...
                      <h4 className="mt-4">
                        Discover What Sets Nassayem Salalah Apart in Property
                        Management
                      </h4>
                    </div>
                    <p>
                      At Nassayem Salalah, we are dedicated to providing
                      exceptional property management services tailored to both
                      tenants and property owners. With deep local expertise and
                      a commitment to excellence, we ensure seamless rental
                      experiences, whether you're looking for a short-term stay
                  ...
                  <div className="box-right">
                    ...
                    <div className="box-service style-1 hover-btn-view">
                      ...
                      <div className="content">
                        <h6 className="title">Short-Term Rentals</h6>
                        <p className="description">
                          Find cozy and convenient accommodations for your stay
                          in Salalah, whether it's for Khareef season or a
                          weekend getaway.
                        </p>
                        <Link
                          href="/short-term-rentals"
                          className="btn-view style-1"
                        >
                          <span className="text">Learn More</span>{" "}
                          <span className="icon icon-arrow-right2" />{" "}
                        </Link>
                    ...
                    {/* Service 2: Long-Term Rentals */}
                    <div className="box-service style-1 hover-btn-view">
                      <div className="icon-box">
                        <span className="icon icon-rent-home" />
                      </div>
                      <div className="content">
                        <h6 className="title">Long-Term Rentals</h6>
                        <p className="description">
                          Secure your ideal home for extended stays with
                          flexible lease terms and modern amenities.
                        </p>
                        <Link
                    ...
                    <div className="box-service style-1 hover-btn-view">
                      <div className="icon-box">
                        <span className="icon icon-property-management" />
                      </div>
                      <div className="content">
                        <h6 className="title">Property Management</h6>
                        <p className="description">
                          Let us handle tenant screening, maintenance, and rent
                          collection while you enjoy passive income from your
                          property.
                        </p>
                        <Link
                  ...
                  <SwiperSlide>
                    <div className="partner-item">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <g opacity="0.5" clipPath="url(#clip0_1_17747)">
                          <path
                  ...
                  <SwiperSlide>
                    <div className="partner-item">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <g opacity="0.5" clipPath="url(#clip0_1_17753)">
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                  ...
                  <SwiperSlide>
                    <div className="partner-item">
                      ...
                      >
                        <g opacity="0.5">
                          <path
                            d="M19.0801 2.20508H42.3239L25.235 27.5342H1.99121L19.0801 2.20508Z"
                            fill="#161E2D"
                          />
                          <path
                    ...
                    <div className="partner-item">
                      ...
                      >
                        <g opacity="0.5">
                          ...
                          />
                          <path
                            d="M103 30.0861V9.8418H106.504V30.0861H103Z"
                            fill="#161E2D"
                          />
                          <path
                  ...
                  <form action="#" className="box-contact-v2">
                    ...
                    <div className="box">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        defaultValue="nssayemsalalah@gmail.com"
                      />
                    </div>
                    <div className="box">
