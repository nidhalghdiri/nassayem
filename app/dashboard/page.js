          ...
          <div className="flat-counter-v2 tf-counter">
            <div className="counter-box">
              ...
              <div className="content-box">
                ...
                <div className="d-flex align-items-end">
                  <h6 className="number" data-speed={2000} data-to={17}>
                    <CountetNumber count={17} />
                  </h6>
            ...
            <div className="counter-box">
              ...
              <div className="content-box">
                ...
                <div className="d-flex align-items-end">
                  <h6 className="number" data-speed={2000} data-to={0}>
                    <CountetNumber count={0} />
                  </h6>
                </div>
              </div>
            </div>
            <div className="counter-box">
              ...
              <div className="content-box">
                ...
                <div className="d-flex align-items-end">
                  <h6 className="number" data-speed={2000} data-to={1}>
                    <CountetNumber count={1} />
                  </h6>
                </div>
              </div>
            </div>
            ...
            <div className="col-xl-9">
              <div className="widget-box-2 wd-listing">
                ...
                <div className="d-flex gap-4">
                  <span className="text-primary fw-7">17</span>
                  <span className="text-variant-1">Results found</span>
                </div>
