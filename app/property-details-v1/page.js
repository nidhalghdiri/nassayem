                ...
                <div className="content-bottom">
                  ...
                  <div className="info-box">
                    ...
                    <p className="meta-item">
                      <span className="icon icon-mapPin" /> 8 Broadway,
                      Brooklyn, New York
                    </p>
                  </div>
                ...
                <div className="col-lg-8">
                  <div className="single-property-element single-property-desc">
                    ...
                    <p className="body-2 text-variant-1">
                      ...
                      and the Iton valley, in a beautiful wooded park bordered
                      by a charming stream, this country property immediately
                      seduces with its bucolic and soothing environment.
                    </p>
                    <p className="mt-8 body-2 text-variant-1">
                      An ideal choice for sports and leisure enthusiasts who
                      will be able to take advantage of its swimming pool (11m x
                  ...
                  <div className="single-property-element single-property-nearby">
                    ...
                    <p className="body-2">
                      Explore nearby amenities to precisely locate your property
                      and identify surrounding conveniences, providing a
                      comprehensive overview of the living environment and the
                      property's convenience.
                    </p>
                      ...
                      <div className="archive-top">
                        ...
                        <div className="content">
                          ...
                          <div className="desc">
                            <i className="fs-16 icon icon-mapPin" />
                            <p>
                              21 Hillside Drive, Beverly Hills, California
                            </p>{" "}
                          </div>
                          <ul className="meta-list">
                            <li className="item">
