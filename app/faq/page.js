                  ...
                  <ul className="box-faq" id="wrapper-faq">
                    <li className="faq-item" onClick={() => handleAccordion(1)}>
                      ...
                      >
                        <p className="faq-body">
                          ...
                          yourself with the platform, you are ready to start
                          using our services. Whether it's accessing specific
                          features, making transactions, or utilizing our tools,
                          you'll find everything you need at your fingertips.
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="faq-item" onClick={() => handleAccordion(3)}>
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 3 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq"
                      >
                        <p className="faq-body">
                    ...
                    <li className="faq-item" onClick={() => handleAccordion(4)}>
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 4 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq"
                      >
                        <p className="faq-body">
                    ...
                    <li className="faq-item" onClick={() => handleAccordion(5)}>
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 5 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq"
                      >
                        <p className="faq-body">
                  ...
                  <ul className="box-faq" id="wrapper-faq-two">
                    <li className="faq-item" onClick={() => handleAccordion(6)}>
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 6 ? "collapse show" : "collapse"
                        }`}
                    ...
                    <li className="faq-item" onClick={() => handleAccordion(7)}>
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 7 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-two"
                      >
                        <p className="faq-body">
                    ...
                    <li className="faq-item" onClick={() => handleAccordion(8)}>
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 8 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-two"
                      >
                        <p className="faq-body">
                    ...
                    <li className="faq-item" onClick={() => handleAccordion(9)}>
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 9 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-two"
                      >
                        <p className="faq-body">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 10 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-two"
                      >
                        <p className="faq-body">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 11 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-two"
                      >
                        <p className="faq-body">
                  ...
                  <ul className="box-faq" id="wrapper-faq-three">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 12 ? "collapse show" : "collapse"
                        }`}
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 13 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-three"
                      >
                        <p className="faq-body">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 14 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-three"
                      >
                        <p className="faq-body">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 15 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-three"
                      >
                        <p className="faq-body">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 16 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-three"
                      >
                        <p className="faq-body">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`${
                          isAccordion == 17 ? "collapse show" : "collapse"
                        }`}
                        data-bs-parent="#wrapper-faq-three"
                      >
                        <p className="faq-body">
