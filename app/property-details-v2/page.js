      ...
      <Layout headerStyle={1} footerStyle={1}>
        <div>
          <section className="banner-property-2">
            <img
              src="/images/banner/banner-property-4.jpg"
              alt="image-banner"
            />
          </section>
                ...
                <div className="col-lg-8">
                    ...
                    <div className="widget-box-header-single">
                        ...
                        <div className="content-bottom">
                          <div className="info-box">
                            ...
                            <ul className="meta">
                              ...
                              <li className="meta-item">
                                <span className="icon icon-bathtub" /> 2
                                Bathroom
                              </li>
                              <li className="meta-item">
                      ...
                      <div className="single-property-desc">
                        ...
                        <p className="body-2 text-variant-1">
                          Located around an hour away from Paris, between the
                          Perche and the Iton valley, in a beautiful wooded park
                          bordered by a charming stream, this country property
                          immediately seduces with its bucolic and soothing
                          environment.
                        </p>
                        <p className="mt-8 body-2 text-variant-1">
                          An ideal choice for sports and leisure enthusiasts who
                          will be able to take advantage of its swimming pool
                  ...
                  <div className="wrapper-onepage" id="nearby">
                    <div className="widget-box-single single-property-nearby">
                      ...
                      <p className="body-2">
                        Explore nearby amenities to precisely locate your
                        property and identify surrounding conveniences,
                        providing a comprehensive overview of the living
                        environment and the property's convenience.
                      </p>
                    ...
                    <div className="widget-box single-property-contact bg-white">
                      ...
                      <div className="box-avatar">
                        ...
                        <div className="info">
                          ...
                          <span>+968 9848 8802 nssayemsalalah@gmail.com</span>
                        </div>
                      </div>
                      <form action="#" className="contact-form">
                        ...
                        <div className="ip-group">
                          ...
                          <input
                            type="text"
                            placeholder="nssayemsalalah@gmail.com"
                            className="form-control"
                          />
                        </div>
                        <div className="ip-group">
