                ...
                <div className="box col-lg-4 col-md-6">
                  <div className="box-service style-2">
                    ...
                    <div className="content">
                      ...
                      <Link href="#" className="tf-btn size-1">
                        Find A Home
                      </Link>
                    </div>
                  </div>
                      ...
                      <SwiperSlide>
                        <div className="box-tes-item">
                          ...
                          <p className="note body-1">
                            ...
                            knowledge of the brokerage team. They not only
                            helped me find the perfect home but also assisted
                            with legal and financial aspects, making me feel
                            confident and secure in my decision."
                          </p>
                          <div className="box-avt d-flex align-items-center gap-12">
                            <div className="avatar avt-60 round">
                              <img
                                src="/images/avatar/avt-7.jpg"
                                alt="avatar"
                              />
                            </div>
                            <div className="info">
                      ...
                      <SwiperSlide>
                        <div className="box-tes-item">
                          ...
                          <p className="note body-1">
                            ...
                            properties with a professional and attentive
                            approach in every situation. I feel reassured that
                            any issue will be resolved promptly and
                            effectively."
                          </p>
                          <div className="box-avt d-flex align-items-center gap-12">
                            <div className="avatar avt-60 round">
                      ...
                      >
                        ...
                        >
                          <p className="faq-body">
                            ...
                            features, making transactions, or utilizing our
                            tools, you'll find everything you need at your
                            fingertips.
                          </p>
                        </div>
                      </li>
