              ...
              <div className="col-lg-4">
                <aside className="sidebar-blog fixed-sidebar">
                  ...
                  <div className="widget-box bg-surface recent">
                    ...
                    <ul>
                      <li>
                        <Link
                          href="/blog-detail"
                          className="recent-post-item hover-img"
                        >
                          <div className="img-style">
                            <img
                  ...
                  <div className="widget-box bg-surface categories">
                    ...
                    <ul>
                      <li>
                        <Link href="#" className="categories-item">
                      ...
                      <li>
                        <Link href="#" className="categories-item current">
                  ...
                  <div className="widget-box bg-surface tag">
                    ...
                    <ul>
                      ...
                      <li>
                        <Link href="#" className="tag-item current">
                          Realty
                        </Link>
                      </li>
                      <li>
