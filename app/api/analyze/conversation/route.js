      ...
      const reminderResponse = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/reminder`,
        {
          ...
          body: JSON.stringify({
            ...
            customerNumber: convData.customerPhoneNumber,
            customerName: convData.customerName,
            dates: analysis.check_in + " - " + analysis.check_out,
