            ...
            <div className="col-xl-8 col-lg-7">
              <div className="slider-content">
                <div className="heading">
                  <h2
                    className="title wow fadeIn animationtext clip"
                    data-wow-delay=".2s"
                  ...
                  <p
                    className="subtitle body-1 wow fadeIn"
                    data-wow-delay=".8s"
                    data-wow-duration="2000ms"
                  >
                    Discover your private oasis at Homeya, where every corner,
                    from the spacious garden to the relaxing pool, is crafted
                    for your comfort and enjoyment.
                  </p>
                </div>
                <Link href="#" className="tf-btn primary size-2">
                  Contact Us
                </Link>
              </div>
            </div>
                          ...
                          <div className="inner-group">
                            ...
                            <div className="form-group-4 form-style box-filter">
                              ...
                              >
                                ...
                                <span className="text-advanced fw-7">
                                  Advanced
                                </span>
                              </a>
                            </div>
                        ...
                        >
                          ...
                          <div className="grid-2 group-box">
                            ...
                            <div className="group-select grid-2">
                              ...
                              <div className="box-select">
                                <label className="title-select fw-5">
                                  Type
                                </label>
                                <select className="nice-select">
                                  <option data-value={1} className="option">
