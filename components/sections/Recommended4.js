    ...
    <>
      <section className="flat-section-v5 bg-surface flat-recommended flat-recommended-v2">
        <div className="container">
          <div
            className="box-title style-2 text-center wow fadeInUpSmall"
            data-wow-delay=".2s"
          ...
          >
            <div className="col-xl-4 col-md-6">
              <div className="homeya-box style-3">
                <div className="images-group">
                  <div className="images-style">
                    <img src="/images/home/house-1-2.jpg" alt="img" />
                  </div>
                  <div className="top">
                  ...
                  <div className="content">
                    <div className="title text-1 text-capitalize">
                      <Link href="/properties/1" className="link text-white">
                        Al-Saada Commercial District, Salalah 211
                      </Link>
                    </div>
                    {/* <div className="d-flex align-items-center price">
                      <div className="h7 fw-7 text-white">$100,00</div>
            ...
            <div className="col-xl-4 col-md-6">
              <div className="homeya-box style-3">
                <div className="images-group">
                  ...
                  <div className="content">
                    <div className="title text-1 text-capitalize">
                      <Link href="/properties/2" className="link text-white">
                        North Awaqad, Near Salalah Mall
                      </Link>
                    </div>
                    {/* <div className="d-flex align-items-center price">
            ...
            {/* <div className="col-xl-4 col-md-6">
              <div className="homeya-box style-3">
                <div className="images-group">
                  ...
                  <div className="content">
                    <div className="title text-1 text-capitalize">
                      <Link href="/properties/3" className="link text-white">
                        Al-Saada, Next to Nasto Hypermarket
                      </Link>
                    </div>
                     <div className="d-flex align-items-center price">
                      <div className="h7 fw-7 text-white">$250,00</div>
            ...
            {/* <div className="col-xl-4 col-md-6">
              <div className="homeya-box style-3">
                <div className="images-group">
                  ...
                  <div className="content">
                    <div className="title text-1 text-capitalize">
                      <Link href="/properties/4" className="link text-white">
                        Al-Wadi, Opposite Garden Mall
                      </Link>
                    </div>
                     <div className="d-flex align-items-center price">
                      <div className="h7 fw-7 text-white">$250,00</div>
              ...
              <div className="homeya-box style-3">
                <div className="images-group">
                  ...
                  <div className="content">
                    ...
                    <div className="d-flex align-items-center price">
                      <div className="h7 fw-7 text-white">$2050,00</div>
                      <span className="text-white">/SqFT</span>
                    </div>
                    <ul className="meta-list">
                      <li className="item">
